...
class LLpaySubmit {
	...
	/**
	 *连连认证支付网关地址
	 *线上地址为https://yintong.com.cn/llpayh5/authpay.htm?
	 */
	...
	function buildRequestMysign($para_sort)
    {
        ...
        file_put_contents("log.txt","para_sort:".var_export($para_sort,true)."\n", FILE_APPEND);
		$prestr = createLinkstring($para_sort);
        file_put_contents("log.txt","prestr:".var_export($prestr,true)."\n", FILE_APPEND);
		$mysign = "";
        $prestr = stripslashes($prestr);
        file_put_contents("log.txt","prestr2:".var_export($prestr,true)."\n", FILE_APPEND);
