...
<body>
	<div class="wrap">
		...
		<div id="header">
			<div class="content">
				<ul id="nav_left">
					<li><a href="###" class="font1 color1"><img src="<?php echo $this->absBaseUrl; ?>/image/site/phone.png">手机版</a></li>
					<li><a href="###" class="font1 color1"><img src="<?php echo $this->absBaseUrl; ?>/image/site/weixin.png">官方微信</a></li>
					<li><a href="###" class="font1 color1"><img src="<?php echo $this->absBaseUrl; ?>/image/site/qq.png">QQ群</a></li>
					<li><a href="###" class="font1 color1"><img src="<?php echo $this->absBaseUrl; ?>/image/site/microblog.png">微博</a></li>
					<li><span class="line">|</span></li>
					<li><a class="font1 color1">全国客服电话：400-002-0802<span class="font1 color6">(工作日 9：00 - 19：00)</span></a></li>
				</ul>
				<ul id="nav_right">
					<li class="first_child"><a href="###" class="font1 color1">帮助中心</a></li>
					<li><span class="line">|</span></li>
					<li><a href="###" class="font1 color1">账户中心</a></li>
					<li><a href="###" class="font1 color1">登录</a></li>
					<li><a href="###" class="font1 color1"><img src="<?php echo $this->absBaseUrl; ?>/image/site/news.png">消息<span class="font1 color7">2</span></a></li>
				</ul>
			</div>
			<div class="clear"></div>
		</div>
		<div id="logo">
			<div class="content">
				<ul id="nav_left">
					<li><a href="###"><img src="<?php echo $this->absBaseUrl; ?>/image/site/logo.png"></a></li>
				</ul>
				<ul id="nav_right">
					...
					<li><a href="###" class="font44 color1">产品列表</a></li>
					<li><a href="###" class="font44 color1">首页</a></li>
				</ul>
			</div>
			<div class="clear"></div>
		</div>
